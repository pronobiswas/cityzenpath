...
class RTForm_Email extends \Elementor\Widget_Base
{
    ...
    {
        return 'rform-widget-icon rtmicon rtmicon-email-form';
    }
    ...
    {
        return ['email', 'fields', 'input', 'rometheme form'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control('label_text', [
            ...
            'default' => esc_html__('Email', 'romethemeform'),
            'condition' => [
                'show_label' => 'yes'
            ]
        ]);
        ...
        <div class="rform-container">
            <div class="rform-control <?php echo esc_attr($settings['label_position']) ?>">
                <?php if ('yes' === $settings['show_label']) : ?>
                    <label class="rform-label-input" for="rform-input-email-<?php echo esc_attr($this->get_id_int()); ?>">
                        <?php echo esc_html__($label_text, 'romethemeform') ?>
                        <?php if ('yes' === $settings['required_input']) : ?><span> * </span><?php endif; ?>
                    </label>
                <?php endif; ?>
                <input name="<?php echo esc_attr($settings['name_input']) ?>" placeholder="<?php echo esc_attr($settings['placeholder_input']) ?>" class="rform-input" id="rform-input-email-<?php echo esc_attr($this->get_id_int()); ?>" type="email" onblur="validate_input( '<?php echo esc_js('rform-input-email-') ?>' , '<?php echo esc_js('rform-input-err-') ?>' ,'<?php echo esc_js($this->get_id_int()); ?>')" aria-invalid=false data-val="<?php echo esc_attr($validation_type) ?>" <?php if ($settings['max_length']) : ?> data-val-maxLength="<?php echo esc_attr($max_length); ?>" <?php endif; ?> <?php if ($settings['min_length']) : ?> data-val-minLength="<?php echo esc_attr($min_length) ?>" <?php endif; ?> <?php echo ('yes' === $settings['required_input']) ? esc_attr('required') : '' ?>>
            </div>
