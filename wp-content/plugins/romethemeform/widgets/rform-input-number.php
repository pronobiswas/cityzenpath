...
class RTForm_Number extends \Elementor\Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control('label_text', [
            ...
            'default' => esc_html__('Number', 'romethemeform'),
            'condition' => [
                'show_label' => 'yes'
            ]
        ]);
        ...
        $this->add_control('name_input', [
            ...
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => esc_html__('rform-number', 'romethemeform'),
        ...
        $this->add_control('min_length', [
            'label' => esc_html__('Min Value', 'romethemeform'),
            'type' => \Elementor\Controls_Manager::NUMBER,
        ]);

        $this->add_control('max_length', [
            'label' => esc_html__('Max Value', 'romethemeform'),
            'type' => \Elementor\Controls_Manager::NUMBER,
        ]);
        ...
        $this->add_responsive_control('input_padding', [
            ...
            'size_units' => ['px', '%', 'em', 'rem'],
            'selectors' => [
                '{{WRAPPER}} .rform-input-number' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}'
            ]
        ]);
        ...
        $this->add_responsive_control('input_margin', [
            ...
            'size_units' => ['px', '%', 'em', 'rem'],
            'selectors' => [
                '{{WRAPPER}} .rform-input-number' => 'margin:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}'
            ]
        ]);
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .rform-input-number',
            ]
        );
        ...
        $this->add_responsive_control('input_border_radius', [
            ...
            'size_units' => ['px', '%', 'em', 'rem'],
            'selectors' => [
                '{{WRAPPER}} .rform-input-number' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}'
            ],
        ]);
        ...
        $this->add_control('input_color_normal', [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .rform-input-number' => 'color:{{VALUE}}'
            ],
        ]);
        $this->add_group_control(
        ...
        $this->add_control('input_color_hover', [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .rform-input-number:hover' => 'color:{{VALUE}}'
            ],
        ]);
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                ...
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .rform-input-number:hover',
            ]
        );
        ...
        $this->add_control('input_color_focus', [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .rform-input-number:focus' => 'color:{{VALUE}}'
            ],
        ]);
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                ...
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .rform-input-number:focus',
            ]
        );
        ...
        $this->add_control('input_color_warning', [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .rform-input-number[aria-invalid="true"]' => 'color:{{VALUE}}'
            ],
        ]);
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                ...
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .rform-input-number[aria-invalid="true"]',
            ]
        );
        ...
        $this->add_control('placeholder_color', [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .rform-input-number::placeholder' => 'color:{{VALUE}}',
                '{{WRAPPER}} .rform-input-number::-webkit-input-placeholder' => 'color:{{VALUE}}',
                '{{WRAPPER}} .rform-input-number::-ms-input-placeholder' => 'color:{{VALUE}}'
            ]
        ]);
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .rform-input-number::placeholder',
            ]
        );
        ...
        <div class="rform-container">
            <div class="rform-control <?php echo esc_attr($settings['label_position']) ?>">
                <?php if ('yes' === $settings['show_label']) : ?>
                    <label class="rform-label-input" for="rform-input-number-<?php echo $this->get_id_int(); ?>">
