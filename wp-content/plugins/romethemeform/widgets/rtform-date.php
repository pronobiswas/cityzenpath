...
class RTForm_Date extends \Elementor\Widget_Base
{
    ...
    {
        return 'rform-widget-icon rtmicon rtmicon-date-form';
    }
    ...
    {
        return ['date', 'fields', 'input', 'rometheme form'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control('label_text', [
            ...
            'default' => esc_html__('Date', 'romethemeform'),
            'condition' => [
                'show_label' => 'yes'
            ]
        ]);
        ...
        $this->add_control('name_input', [
            ...
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => esc_html__('rform-date', 'romethemeform'),
